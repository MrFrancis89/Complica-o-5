// ft-dashboard.js — v3.0
// Feat 8: alerta de margem negativa  +  badge no nav
        ...
        <div class="ft-alerta-margem">
            ...
            <div class="ft-alerta-body">
                ...
                <div class="ft-alerta-sub">
                    ${negativas.map(it =>
                        `<span class="ft-alerta-nome">${_esc(it.r.nome)}</span>`
                    ).join('')}
                </div>
        ...
        <div class="ft-destaques">
            <div class="ft-dest ft-dest-green">
                ...
                <div>
                    ...
                    <div class="ft-dest-name">${_esc(recs[iML].nome)}</div>
            ...
            <div class="ft-dest ft-dest-amber">
                ...
                <div>
                    ...
                    <div class="ft-dest-name">${_esc(recs[iMC].nome)}</div>
